...
public class DriveSubsystem extends SubsystemBase {
  private final SpeedControllerGroup m_leftMotors = new SpeedControllerGroup(new Spark(DriveConstants.kLeftMotor1Port), new Spark(DriveConstants.kLeftMotor2Port));
  private final SpeedControllerGroup m_rightMotors = new SpeedControllerGroup(new Spark(DriveConstants.kRightMotor1Port), new Spark(DriveConstants.kRightMotor2Port));
  ...
  public void periodic()
  {
    ...
    m_odometry.update(gyroAngle, getLeftEncoder().getDistance(), getRightEncoder().getDistance());
  }
